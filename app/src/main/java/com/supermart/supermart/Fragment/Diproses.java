...
public class Diproses extends Fragment {
    ...
    public Diproses(ViewPager viewPager) {
    ...
    private void initDaftarPesanan() {
        String url = "https://supermart.herokuapp.com/daftar/pesanan/diproses/" + Util.imei;
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    Diproses.this.daftar_pesanan = new JSONArray(response);
                    DaftarPesananAdapter adapter = new DaftarPesananAdapter(Diproses.this.daftar_pesanan, Diproses.this, false, viewPager);
                    Diproses.this.daftar_pesanan_lv.setAdapter(adapter);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Diproses.this.getContext(), "Gagal mengambil data !", Toast.LENGTH_SHORT).show();
            }
        });
